package com.hyy.ifm.util.cj;

import com.hyy.ifm.util.MD5;
...
//	public static final String CHARSET = "UTF-8";
	...
	public static String sendPost(Map<String, String> origMap, String charset,
			String MERCHANT_PRIVATE_KEY, String GATEWAY_URL) {
		String resultString ="";
		try {
			...
			resultString = ChanPayUtil.buildRequest(sPara, "RSA",
					MERCHANT_PRIVATE_KEY, charset, GATEWAY_URL);
		} catch (Exception e) {
	...
	public static void sendFilePost(Map<String, String> origMap,
			...
			String strParaFileName, String strFilePath, String BATCH_FILE_GATEWAY_URL) {
		try {
			...
			String resultString = ChanPayUtil.buildFileRequest(sPara, "RSA",
					...
					BATCH_FILE_GATEWAY_URL, strParaFileName,
					strFilePath);
	...
	public static String createLinkString(Map<String, String> params,
		...
		String charset = params.get(INPUT_CHARSET);
