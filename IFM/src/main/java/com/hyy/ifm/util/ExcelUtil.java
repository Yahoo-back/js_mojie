...
public class ExcelUtil {
     ...
     * @param response
     */
    public static void exportExcel(String fileName, String sheetName, String[] titles, List<List<Object>> recordList, HttpServletResponse response) {
     ...
     * @param response
     */
    public static void exportExcel(String fileName, String sheetName, int pageSize, String[] titles, List<List<Object>> recordList, HttpServletResponse response) {
                ...
                for (int j = start, row = 1; j < end; j++, row++) {
                    ...
                    for (int k = 0; k < record.size(); k++) {
                        ...
                        if (object instanceof Date) {
                            value = com.hyy.ifm.util.DateUtil.DateToString((Date) object, DATEFORMAT);
                        } else {
    ...
    public static List<String[]> getData(InputStream inp) {
        Workbook wb = null;
        List<String[]> dataList = new ArrayList<String[]>(100);
        try {
            wb = WorkbookFactory.create(inp);
