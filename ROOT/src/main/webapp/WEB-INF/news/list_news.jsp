...
<html style="height: 100%">
	<head>
		...
		<script defer type="text/javascript" src="${base}/static/script/news.js"></script>
	...
	<div class="list_title1">
		<a href="#" class="easyui-linkbutton color-orange" style="margin-right: 10px;" onclick="addNews('')">新增资讯</a>
