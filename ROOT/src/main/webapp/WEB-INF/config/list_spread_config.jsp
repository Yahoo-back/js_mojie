...
<html style="height: 100%">
	<head>
		...
		<script defer type="text/javascript" src="${base}/static/script/config_spread.js"></script>
		<style type="text/css">
	...
	<div class="list_title1">
		<a href="#" class="easyui-linkbutton color-orange" style="margin-right: 10px;" onclick="addSpreadConfig('')">新增推广</a>
