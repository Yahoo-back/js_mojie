...
<form id="vehicle_add_form" method="post" >
	<input type="hidden" name="id" id="id"/>
		<table border="1" bordercolor="#a0c6e5" class="tb-customer" style="border-collapse:collapse;width: 100%" align="center">
			<tr>
				<td style="width: 100px;" align="right"><font color="red">*</font>值1(区间)：</td>
			...
			<tr>
				<td style="width: 100px;" align="right"><font color="red">*</font>值2(区间)：</td>
				<td colspan="3"><input class="easyui-validatebox" data-options="required:true" type="text" name="item_key" id="item_key" style="width: 500px"></input></td>
			</tr>
<%--			<tr>--%>
...
<%--				</td>--%>
			...
			<tr>
				...
				<td>
					<input class="easyui-validatebox" type="text" data-options="required:false, validType : 'integer'" name="xh" id="xh" style="width: 300px"></input>
				</td>
			</tr>
		</table>
