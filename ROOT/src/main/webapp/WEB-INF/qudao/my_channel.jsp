...
<head>
    ...
    <script defer type="text/javascript" src="${base}/static/script/my_channel.js"></script>
    <style type="text/css">
...
<div class="list_title1">
    <br>
    <font style="float: left; margin-left: 10px;">用户注册时间：</font>
    <input id='visit_time_FROM_cnd' onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class='Wdate' readonly='readonly' type='text' name='visit_time_FROM' style="width: 150px;float:left">
    <font style="float: left">&nbsp;&nbsp;-&nbsp;&nbsp;</font>
    <input id='visit_time_TO_cnd' onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class='Wdate' readonly='readonly' type='text' name='visit_time_TO' style="width: 150px;float:left">
    <font style="float: left">&nbsp;&nbsp;&nbsp;&nbsp;</font>
