...
<html>
	<head>
		...
		<script defer type="text/javascript" src="${base}/static/script/data_charts_page.js"></script>
	...
	<div class="list_title1">
		...
		<div id="p" class="easyui-panel" fit="true"  >
			<div style="width: 100%;height: 26px">
                ...
                <br><br>
<style>
	#page_chose_div{ width: 100%;
		overflow: hidden;
		margin: 10px 0 0;
	}
	#page_chose_div input{
		 margin: 0 4px 0 14px;

	}
</style>
                <div id="page_chose_div" style="float:left; font-size: 15px">
                </div>
                <font style="float: left">&nbsp;&nbsp;&nbsp;&nbsp;</font>
