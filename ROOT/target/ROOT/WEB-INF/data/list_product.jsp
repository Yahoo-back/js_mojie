...
<html style="height: 100%">
	<head>
		...
		<script defer type="text/javascript" src="${base}/static/script/data_product.js"></script>
		<style type="text/css">
	...
	<div class="list_title1">
		<br>
		<font style="float: left; margin-left: 10px;">请选1择日期：</font>
		<input id='visit_time_FROM_cnd' onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH'})" class='Wdate' readonly='readonly' type='text' name='visit_time_FROM' style="width: 150px;float:left">
		<font style="float: left">&nbsp;&nbsp;-&nbsp;&nbsp;</font>
		<input id='visit_time_TO_cnd' onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH'})" class='Wdate' readonly='readonly' type='text' name='visit_time_TO' style="width: 150px;float:left">
		<font style="float: left">&nbsp;&nbsp;&nbsp;&nbsp;</font>
		<font style="float: left; margin-left: 10px;">商品名称：</font>
		<input id='product_name_cnd' class='layui-input' type='text' name='product_name' style="width: 150px;float:left;">
