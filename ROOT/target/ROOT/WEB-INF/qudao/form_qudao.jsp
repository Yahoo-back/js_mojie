...
<table border="1" bordercolor="#a0c6e5" class="tb-customer"  style="border-collapse:collapse;width: 100%" align="center" >
	<tr>
		<td style="width: 100px;" align="right"><font color="red">*</font>姓名：</td>
		...
		<td for="email" align="right"><font color="red">*</font>登录账号:</td>
...
<%--		</td>--%>
	...
	<tr>
		<td style="width: 100px;" align="right"><font color="red">*</font>金额:</td>
		<td>
			<input class="easyui-validatebox"  class="easyui-validatebox" data-options="required:true" type="text" onblur="chkvalue(this)" name="cpa" id="cpa" style="width: 200px"></input>
            <font color="red">*</font>CPA：<select style="width: 100px" class="easyui-validatebox layui-select" data-options="required:true" name="cpaType" id="cpaType">
				<option value="">--请选择--</option>
				<option value="0">uv</option>
				<option value="1">注册</option>
			</select>
		</td>
		<td style="width: 100px;" align="right"><font color="red">*</font>放款率：</td>
		<td><input class="easyui-validatebox layui-input" data-options="required:true" type="text" onblur="chkvalue(this)" name="loanRate" id="loanRate" style="width: 200px"></input></td>
	...
	<script type="text/javascript">
		$(function () {
			setTimeout(function () {
				...
				qryUser('<%=(null == request.getParameter("id") ? "" : request.getParameter("id"))%>', '<%=(null == request.getParameter("view") ? "" : request.getParameter("view"))%>');
			}, 200);
		});
	</script>
</form>