...
<html style="height: 100%">
    <head>
        ...
        <script defer type="text/javascript" src="${base}/static/script/product.js"></script>
...
<div class="list_title1">
    <a href="#" class="easyui-linkbutton color-orange" style="margin-right: 10px;" onclick="addProduct('')">新增商品</a>
