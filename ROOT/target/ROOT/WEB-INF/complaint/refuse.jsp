...
<form id="vehicle_add_form" method="post" >
    ...
    <div class="easyui-accordion">
        <div title="驳回" class="easyui-panel">
...
<%--                </tr>--%>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //     }
            qryRefuse('<%=(null == request.getParameter("id") ? "" : request.getParameter("id"))%>', '<%=(null == request.getParameter("view") ? "" : request.getParameter("view"))%>');
