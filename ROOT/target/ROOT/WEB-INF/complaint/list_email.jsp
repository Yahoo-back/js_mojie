...
<head>
    ...
    <script defer type="text/javascript" src="${base}/static/script/list_email.js"></script>
    <style type="text/css">
...
<div class="list_title1">
    ...
    <font style="float: left; margin-left: 10px;">银行卡号：</font>
    <input id='bank_card_cnd' class='layui-input' type='text' name='bank_card_name' style="width: 150px;float:left;">
    <font style="float: left; margin-left: 10px;">订单号：</font>
    <input id='request_no_cnd' style="width: 180px;" class='layui-input' type='text' name='request_no_name'  style="width: 150px;float:left;">
