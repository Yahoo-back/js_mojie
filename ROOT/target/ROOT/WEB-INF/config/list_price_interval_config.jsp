...
<html style="height: 100%">
	<head>
		...
		<script defer type="text/javascript" src="${base}/static/script/config_price_interval.js"></script>
		<style type="text/css">
	...
	<div class="list_title1">
		<a href="#" class="easyui-linkbutton color-orange" style="margin-right: 10px;" onclick="addPriceInterval('')">新增价格区间</a>
		...
		<input type="hidden" name="data_type_cnd" id="data_type_cnd"/>
