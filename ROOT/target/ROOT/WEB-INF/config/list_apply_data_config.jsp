...
<html style="height: 100%">
	<head>
		...
		<script defer type="text/javascript" src="${base}/static/script/config_apply_data.js"></script>
		<style type="text/css">
	...
	<div class="list_title1">
		<a href="#" class="easyui-linkbutton color-orange" style="margin-right: 10px;" onclick="addApplyData('')">新增申请资料</a>
