...
$(function() {
    var cust_tb = $.et.commonQuery('#cust_tb',{
        url:st.apiPath+'qryMyChannelList',
        fit:true,
        ...
        columns:[[
            ...
            {field:"uv",title:"实际uv数",width:80,sortable:true,headalign:"center",fuzzy_condition: function () {
                    return "";
                }},
            {field:"dropUv",title:"缩量uv数",width:80,sortable:true,headalign:"center",fuzzy_condition: function () {
                    return "";
                }},
            // {field:"count_uv",title:"注册",width:80,sortable:true,headalign:"center",fuzzy_condition: function () {
            //         return "";
            //     }},
            {field:"count",title:"实际注册数",width:80,sortable:true,headalign:"center",fuzzy_condition: function () {
                    return "";
                }},
            {field:"dropCount",title:"缩量注册数",width:80,sortable:true,headalign:"center",fuzzy_condition: function () {
                    return "";
                }},
            {field:"cpaPay",title:"CPA金额",width:80,sortable:true,headalign:"center",fuzzy_condition: function () {
                    return "";
                }},
            {field:"withholdPay",title:"扣款金额",width:80,sortable:true,headalign:"center",fuzzy_condition: function () {
                    return "";
                }},
            {field:"order",title:"认证数",width:80,sortable:true,headalign:"center",fuzzy_condition: function () {
                    return "";
                }},
            {field:"orderLead",title:"认证率（%）",width:80,sortable:true,headalign:"center",fuzzy_condition: function () {
                    return "";
                }},
        ]],
