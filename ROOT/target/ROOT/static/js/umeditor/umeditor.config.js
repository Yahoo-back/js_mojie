...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"http://192.168.10.166:8080/ycgz/FileUpload"             //图片上传提交地址
        ,imagePath:"http://192.168.10.166:8080/ycgz/FileUpload"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        //,imageUrlPrefix: "http://192.168.10.166:8080/ycgz/FileUpload" /* 图片访问路径前缀 */
        ,imageFieldName:"headImg"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
